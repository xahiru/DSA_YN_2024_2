...
3: Write a function to delete an element from an array at a specified position.Write a function to delete an element from an array at a specified position.
